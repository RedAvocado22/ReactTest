...
const MovieSearchApp = () => {
  ...
  return (
    <div className="p-10">
      <div className="mx-auto mb-20 w-full max-w-[500px]">
        <input
          type="text"
          className="w-full rounded-lg border border-purple-500 p-5 shadow-[0px_0px_0px_3px_rgba(125,_106,_255,_0.2)]"
  ...
  return (
    <div className="flex flex-col rounded-2xl bg-white p-3 shadow-sm">
      ...
      <div className="flex flex-1 flex-col p-7">
        ...
        <p className="mb-6 text-sm !leading-loose text-[#999]">
